...
/**
 * @author lhp
 * @version HtmlTableConverter.java create at 2024-03-11 12:42:58 by lhp
 * @since 1.0.0
 */
public class HtmlTableConverter extends AbstractHtmlNodeConverter {

  @Override
  public HtmlNodeTypeEnum type() {
    return HtmlNodeTypeEnum.TABLE;
  }
