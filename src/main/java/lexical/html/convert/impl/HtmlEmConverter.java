...
/**
 * @author lhp
 * @version HtmlEmConverter.java create at 2024-03-11 13:46:06 by lhp
 * @since 1.0.0
 */
public class HtmlEmConverter extends AbstractHtmlNodeConverter {

  @Override
  public HtmlNodeTypeEnum type() {
    return HtmlNodeTypeEnum.EM;
  }
